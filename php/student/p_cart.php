<?php 
    ...
    function retrieveCartEntries() {
        ...
        $id = $_SESSION['user_id'];
        $select_query=  
            "SELECT BASE.cart_entry_id, BASE.course_name, BASE.instructor_name, BASE.occurrence, BASE.schedule_time, BASE.room_name,
                CASE
                    ...
                    WHEN BASE.availablity = 0 THEN 'Class Full'
                    ELSE CONCAT( BASE.availablity, ' ', 'Seats Available')
                END AS status
